...
function setup() {
  ...
  synth = new Tone.MonoSynth({
    ...
    filterEnvelope: { attack: 0.01, decay: 0.3, sustain: 0.5, release: 1, baseFrequency: 200, octaves: 4 }
  }).toDestination();
...
function draw() {
  ...
  for (let i = 0; i < 16; i++) {
    ...
    // Pitch knob
    drawKnob(s.x + 10, s.y + 100, 30, s.pitch, 36, 84, "P");
    
    // Decay knob
    drawKnob(s.x + 10, s.y + 200, 30, s.decay, 0.1, 2.0, "D");
  }
