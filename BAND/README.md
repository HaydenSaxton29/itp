...
Using link to from the sample website so it didn't work but then we also copied the file and altered it which fixed it
...
Eli and George did the majority of the work with the coding/formatting and Andrew did a little bit too like the name and his paragraph. 
